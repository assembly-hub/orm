...
***注：$or $and算子内部即可以包含基础算子，也可以嵌套 $or $and 算子***
### 20、$or 或算子，其内部为基础算子
```go
...
> fetch 数据推送方法，需要自定义；返回true，继续接收下一行数据，返回false，停止数据查询
